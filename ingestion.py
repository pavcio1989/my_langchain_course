...
from logger import (Colors, log_error, log_header, log_info, log_warning, log_success)
...
vectorstore = PineconeVectorStore(
    index_name="langchain-doc-index-2025", embedding=embeddings
)
...
async def main():
    ...
    log_info(f"📚  TavilyCrawl: Starting to Crawl documentation from https://python.langchain.com/",
             Colors.PURPLE,)
